...
export const metadata = {
  title: "Polityka prywatności — On.balon",
  description: "Polityka prywatności serwisu onbalon.pl",
};
        ...
        <div className="section-inner">
          ...
          <ol>
            <li>
              ...
              adresem url: <b>onbalon.pl</b>
            </li>
            <li>
              Operatorem serwisu oraz Administratorem danych osobowych jest:
              BARON PARTY SPÓŁKA Z OGRANICZONĄ ODPOWIEDZIALNOŚCIĄ Księdza Hugona
              Kołłątaja 14/U2. NIP. 8513281178. REGON. 523216229
            </li>
            <li>
